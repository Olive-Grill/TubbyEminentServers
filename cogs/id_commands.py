...
class IDCommands(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if "mustard" in message.content.lower():
            ...
            embed.set_image(
                url=
                "https://preview.redd.it/what-arethe-most-d-rk-and-off-nsive-kendrick-lamar-lyrics-v0-ogu2u7jcfj4d1.jpeg?auto=webp&s=3a0a1519137e8553e267d84834c351eac738443b"
            )
